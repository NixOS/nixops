...
def disk_id(disk):
    return disk['media_link'] or disk['name']
...
class AzureState(MachineState, ResourceState):
    ...
    def _delete_volume(self, volume_id, disk_id = None):
        ...
        try:
            ...
            if self.depl.logger.confirm("are you sure you want to destroy the contents(BLOB) of Azure disk '{0}'?".format(disk_id or volume_id)):
    ...
    def _create_ephemeral_disks_from_blobs(self, defn):
        for d_id, disk in defn.block_device_mapping.iteritems():
            ...
            try:
                ...
                self.sms().add_disk(device_name_to_lun(disk["device"]) is None,
