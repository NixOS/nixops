...
import functools
import string
from typing import Iterable, Optional, Any, List, Protocol, Tuple, Union, Dict
...
class Container(object):
    def __init__(self, prefix: str, children: List, suffix: str, inline_variant: Optional[ValueLike] = None):
